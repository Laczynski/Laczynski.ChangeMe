...
This workflow is for the generated application's GitLab package. If `template-pack/ChangeMe.Templates.csproj` exists, first confirm that the user wants an application release rather than the separately owned template NuGet release in `docs/system/operations/publishing.md`.
