...
> Scope: frontend
> Status: implemented
> Canonical for: Angular structure, component, form, service, and UI-library implementation rules
>
> Product behaviour: [`product-standards.md`](../../requirements/_shared/conventions/product-standards.md) (L2) and the target `FR-*` (L4). This document owns implementation only.
...
- Deployment patterns (nginx `/api` proxy, CORS, split hosts): [deployment](../../system/operations/deployment.md).
