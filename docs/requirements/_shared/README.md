...
| **L5 Implementation** | `../../modules/*/development.md`, `../../system/development/` | _How do we build it in this repo?_     | Module patterns; [test layer ownership](../../system/development/testing-strategy.md#layer-ownership) when adding tests |
