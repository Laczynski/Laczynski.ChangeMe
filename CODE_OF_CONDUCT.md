...
We as members, contributors, and leaders pledge to make participation in the **ChangeMe** community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, color, religion, or sexual identity and orientation.
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the maintainer listed in [`LICENSE`](LICENSE) or through [GitHub's contact flow](https://docs.github.com/en/site-policy/other-site-policies/github-community-guidelines). All complaints will be reviewed and investigated promptly and fairly.
