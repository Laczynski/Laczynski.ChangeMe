...
using Template.Backend.IntegrationTests.Support.Fakes;
...
public class BackendWebApplicationFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
  ...
  private void ApplyEnvironmentOverrides()
  {
    ...
    environmentOverrides[$"{AuthOptions.SectionName}__Jwt__Issuer"] = "Template.Tests";
    environmentOverrides[$"{AuthOptions.SectionName}__Jwt__Audience"] = "Template.Tests";
