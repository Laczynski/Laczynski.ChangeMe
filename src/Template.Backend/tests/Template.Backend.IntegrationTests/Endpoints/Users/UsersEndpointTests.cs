...
namespace Template.Backend.IntegrationTests.Endpoints.Users;
...
public sealed class UsersEndpointTests(BackendWebApplicationFactory factory)
{
  ...
  public async Task PostUsers_WhenAdministratorCreatesUser_ShouldReturnCreated()
  {
    ...
    var dbContext = scope.ServiceProvider.GetRequiredService<Template.Backend.Infrastructure.Persistence.ApplicationDbContext>();
